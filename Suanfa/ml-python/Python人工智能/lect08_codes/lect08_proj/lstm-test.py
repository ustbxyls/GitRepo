...
# convert time series into supervised learning problem
def series_to_supervised_1(sales, n_in=1, n_out=1, n_vars=2, test_ratio=0.25):
...
def main():
    ...
    for item_sku_id in all_item_sku_ids:
        ...
        for off_set in all_off_sets:
            ...
            print('训练：item_sku_id={}, off_set={}'.format(item_sku_id, off_set))
            ...
            for dc in dcs:
                ...
                print('预测-submit：item_sku_id={}, dc_id={}, off_set={}'.format(item_sku_id, dc, off_set))
